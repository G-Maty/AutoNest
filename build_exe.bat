@echo off
echo AutoNest Advanced - EXEファイル作成スクリプト (アイコン付き)
echo.
...
%PYTHON_PATH% -m PyInstaller --onefile --windowed --name="AutoNest_Advanced" --icon=icon.ico --add-data="config.json;." advanced_folder_creator.py
